...
class Program
{
    static void F(IEnumerable<int[]> x)
    {
        ...
        [Fact]
        public void NestedLambdas_ReturnTypeInference()
        {
            var source = """
                #nullable enable
                ...
                {
                    public static U F<T, U>(this T t, Func<T, U> f) => f(t);
                }
                class Program
                {
                    static void Main()
            ...
            // PROTOTYPE: Too many bound lambdas:
            // (20,25): error CS9218: Too many bound lambdas: bound 16, unbound 48.
            //                     c.F(d =>
        ...
        // PROTOTYPE: A shorter version of NestedLambdas_ReturnTypeInference above. Remove this shorter test.
        [Fact]
        public void NestedLambdas_ReturnTypeInference_PROTOTYPE()
        {
            var source = """
                #nullable enable
                #pragma warning disable 649
            ...
            comp.TestOnlyCompilationData = data;
            // PROTOTYPE: Too many bound lambdas:
            // (18,17): error CS9218: Too many bound lambdas: bound 4, unbound 12.
            //             a.F(b =>
            var diagnostics = comp.GetDiagnostics();
            diagnostics.Verify();
            Assert.Equal("BoundLambdas: 63, UnboundLambdaStates: 129, (11, 13), (21, 43), (31, 73)", data.ToString());
