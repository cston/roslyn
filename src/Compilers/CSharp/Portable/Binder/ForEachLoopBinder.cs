...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal sealed class ForEachLoopBinder : LoopBinder
    {
        ...
        private BoundForEachStatement BindForEachPartsWorker(BindingDiagnosticBag diagnostics, Binder originalBinder)
        {
            ...
            // PROTOTYPE: What about ref? foreach (ref var x in [...]) { }
                ...
                case SyntaxKind.ForEachVariableStatement:
                    {
                        ...
                        // PROTOTYPE: foreach ((T t, U u) in [a, b, c]) { } cannot be target-typed, because unless
                        // we know the type we're deconstructing from, we can't deconstruct. Add to spec.
